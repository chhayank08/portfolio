...
const SkillsSection = () => {
  const skillCategories = [
    ...
    },
    {
      ...
      skills: [
        { name: "LangChain", icon: <Cpu className="w-4 h-4 text-[#1C3C3C]" /> },
        { name: "LangGraph", icon: <Cpu className="w-4 h-4 text-[#1C3C3C]" /> },
        { name: "RAG", icon: <BsGrid1X2 className="w-4 h-4 text-[#9CA3AF]" /> },
        { name: "Gemini API", icon: <Cpu className="w-4 h-4 text-[#4285F4]" /> },
        { name: "OpenRouter", icon: <Cpu className="w-4 h-4 text-[#F59E0B]" /> },
      ],
    },
    {
      icon: Cloud,
    ...
    },
    {
      ...
      skills: [
        ...
        { name: "Supabase", icon: <SiPostgresql className="w-4 h-4 text-[#3ECF8E]" /> },
        { name: "Langfuse", icon: <Cpu className="w-4 h-4 text-[#F97316]" /> },
